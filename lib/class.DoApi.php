	...
	class DoAPI
	{
		...
		*/
		...
		/****
			...
			* @copyright 2012 Mandoo TM
		*/
		public function doMail_GetNumSubscribersFromGroups($ids = null)
		{
			$params = "ids=0";
			if (isset($ids) && $ids != null && $ids != "" && $ids != 0) {
				$params = "ids=" . $ids;
			}
			$this->method = "doMail_GetNumSubscribersFromGroups";
			return $this->Call_Mandoo_Api_V1($params);
		}
		/****
			* @category doMail
			...
			* @copyright 2012 Mandoo TM
		*/
		public function doMail_GetNumSubscribersFromSimpleGroup($ids = null)
		{
			$params = "ids=0";
			if (isset($ids) && $ids != null && $ids != "" && $ids != 0) {
				$params = "ids=" . $ids;
			}
			$this->method = "doMail_GetNumSubscribersFromSimpleGroup";
			return $this->Call_Mandoo_Api_V1($params);
		}
		/****
			* @category doMail
			...
			* @copyright 2012 Mandoo TM
		*/
		public function doMail_GetNumSubscribersFromSmartGroups($ids = null)
		{
			$params = "ids=0";
			if (isset($ids) && $ids != null && $ids != "" && $ids != 0) {
				$params = "ids=" . $ids;
			}
			$this->method = "doMail_GetNumSubscribersFromSmartGroups";
			return $this->Call_Mandoo_Api_V1($params);
		}
		/****
			* @category doMail
