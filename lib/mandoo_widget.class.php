...
class Mandoo_Widget extends WP_Widget {
	...
	public function Mandoo_Widget () {
		$widget_options = array('classname' => 'mandoo_widget', 'description' => __( "Displays a form from your Mandoo™ doForms account.",'mandoo'));
	...
	public function form ($instance) {
		...
		if ($doAPI != false) {
			...
			if ($result[0] != "E:501") {
				...
				?>
						<p>
							<label for="<?php echo $this->get_field_id('form_id'); ?>"><?php echo __('Select a form :','mandoo'); ?></label>
